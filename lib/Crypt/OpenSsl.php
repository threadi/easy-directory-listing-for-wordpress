...
class OpenSSL extends Crypt_Base {
     ...
     * @var string
     */
    protected string $constant = 'EDLFW_HASH';
    ...
    public function init(): void {
        $this->set_hash( $this->is_hash_saved() ? EDLFW_HASH : '' ); // @phpstan-ignore constant.notFound
        ...
        // get hash from db.
        $this->set_hash( get_option( EDLFW_DB_HASH, '' ) );

        // bail if cron or ajax is called or if this is not an admin-request.
        ...
        // add the constant.
        $define                = "define( '" . $this->get_constant() . "', '" . $this->get_hash() . "' ); // Added by Easy Directory Listing for WordPress.\r\n";
    ...
    public function uninstall(): void {
        ...
        // save the hash in db.
        update_option( EDLFW_DB_HASH, $this->get_hash() );
